...
export async function getQuote({ tokenIn, tokenOut, amountIn, slippage = 0.5 }) {
  ...
  try {
    ...
    console.log(`Fetching Uniswap quote: ${url}`);
    ...
    return {
      ...
      amountOut: parseFloat(data.amountOut) / 1e18,
...
export async function getSwapTransaction({
  ...
  try {
    ...
    console.log(`Fetching Uniswap swap transaction: ${url}`);
